...
|---|---|---:|---|---|
| userservice | Usuarios, roles, estados, login | 8081 | leaseflow_users | `/api/usuarios` |
| propertyservice | Propiedades, fotos, ubicación, categorías | 8082 | leaseflow_properties | `/api/propiedades` |
| documentService | Documentos de usuario, tipos, estados | 8083 | leaseflow_documents | `/api/documentos` |
| applicationService | Solicitudes y registros de arriendo | 8084 | leaseflow_applications | `/api/solicitudes` |
| contactService | Mensajes de contacto y respuestas | 8085 | leaseflow_contact | `/api/contacto` |
| reviewService | Reseñas (propiedad/usuario) y promedios | 8086 | leaseflow_reviews | `/api/reviews` |
...
- userservice: https://userservice.calmbeach-1addaf50.brazilsouth.azurecontainerapps.io/swagger-ui/index.html#/
- propertyservice: https://propertyservice.calmbeach-1addaf50.brazilsouth.azurecontainerapps.io/swagger-ui/index.html#/
- documentService: https://documentservice.calmbeach-1addaf50.brazilsouth.azurecontainerapps.io/swagger-ui/index.html#/
- applicationService: https://applicationservice.calmbeach-1addaf50.brazilsouth.azurecontainerapps.io/swagger-ui/index.html#/
- contactService: https://contactservice.calmbeach-1addaf50.brazilsouth.azurecontainerapps.io/swagger-ui/index.html#/
- reviewService: https://reviewservice.calmbeach-1addaf50.brazilsouth.azurecontainerapps.io/swagger-ui/index.html#/
